%skulle gissa att det är samma sak igen, string:equal kanske förväntar sig två listor, strängar är 
%implementerade som listor, så skriver du " " får du en lista med ett element, men enskilda karaktärer är bara 
%ett nummer (ascii-koden) och inte en lista
%testa att patternmatcha med NextChar = 32 (32 är ascii-koden för ett mellanslag)
%alternativt [NextChar] = " " vilket också bör fungera
